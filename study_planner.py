"""
AIMENTORA study planner — generates a personalised, phase-wise UPSC preparation
schedule for the time a candidate has left until their target Prelims, using
AIMENTORA's own features for every task. Pure, deterministic Python.
"""
import datetime
...
# they are scaled to fit the available foundation time. panel = AIMENTORA tab to open.
SUBJECTS = [
