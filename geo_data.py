"""
Profile / DAF option data — categories, UPSC optional subjects, and the
India state -> districts mapping that powers the cascading dropdowns in the
student profile. This is plain factual/geographic reference data.

Served to the frontend via the /geo/profile-options endpoint so the single-page
app can build dropdowns without bloating index.html.
"""

CATEGORIES = ["General", "EWS", "OBC", "SC", "ST", "PwBD"]

PREP_LOCATIONS = ["At home (home town / native place)", "In another city (relocated for prep)"]

COACHING_STATUS = ["Self Preparation", "Ongoing Coaching", "Coaching Completed"]

COACHING_METHOD = ["Online", "Offline", "Self Preparation"]

# Official UPSC Civil Services (Main) optional subjects + literatures
UPSC_OPTIONALS = [
    "Agriculture",
...
# State / UT -> districts. Comprehensive reference list (28 states + 8 UTs).
STATE_DISTRICTS = {
    "Andhra Pradesh": [
    ...
    "Punjab": [
        ...
        "SAS Nagar (Mohali)", "SBS Nagar (Nawanshahr)", "Sri Muktsar Sahib", "Tarn Taran",
    ],
    "Rajasthan": [
...
# Ordered list of states/UTs for the dropdown
INDIA_STATES = list(STATE_DISTRICTS.keys())
