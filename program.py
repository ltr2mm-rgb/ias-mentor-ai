"""
AIMENTORA Guided Program — turns the whole UPSC Prelims preparation into an ordered
queue of ready-to-do tasks. Each task carries an action AIMENTORA performs itself
